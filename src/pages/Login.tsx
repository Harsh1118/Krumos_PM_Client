...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-950 px-4 relative overflow-hidden select-none">
      ...
      <div className="absolute -top-1/4 -left-1/4 w-[600px] h-[600px] bg-[#F44E14]/10 rounded-full blur-[120px] animate-float-1 pointer-events-none" />
      <div className="absolute -bottom-1/4 -right-1/4 w-[700px] h-[700px] bg-indigo-500/10 rounded-full blur-[140px] animate-float-2 pointer-events-none" />
      <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] bg-purple-600/5 rounded-full blur-[110px] animate-float-3 pointer-events-none" />
